 ...
 ******************************************************************************
 * @file    App_Test.h
 * @brief   Selectable UART, motor, WT101, control and Bluetooth test interface
 *
 * @pin_resources
 ...
 *   - Bluetooth activity LED: PC13 external active-high LED output.
 *
 * @peripherals
...
#define APP_TEST_BLUETOOTH 5U

#ifndef APP_TEST_MODE
#define APP_TEST_MODE APP_TEST_BLUETOOTH
#endif
